...
const render = function(str, context) {
  ...
  var partialMatcher = /(<\$>\S*\s\$>)/;
    ...
    //TODO: instead of treating tokens[2] as a single operand, split it into an array of operands
...
helpers.inline.extend(App.viewHelpers.inline); // user-defined helpers cannot override defaults
