      ...
      context('when the token is of type "expression"', function() {
        context('when the expression contains no functions or parentheses', function() {
          ...
          context('when the expression contains multiple operators', function () {
            xcontext('when the operators are all arithmatic', function() {
              const exampleTokens = [
                '23 + 49 + 5',
                '99 - 100 - 2',
                '-1 * 5 * 9',
            ...
            xcontext('when the operators are all comparison', function() {
              const exampleTokens = [
                '19 < 25 === true',
                '90 < 33 === true',
                '25 > 3 !== false',
            ...
            xcontext('when the operators are all logical', function() {
              const exampleTokens = [
                'true && !false',
                'true && !true',
                'false && (false || true)',
            ...
            xcontext('when the operators are a mix of different types', function() {
              const exampleTokens = [
                '10 + 30 > 20 + 5',
                '10 + 30 <= 20 + 5',
                '10 < 30 || 20 > 10',
